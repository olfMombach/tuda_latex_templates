%% This is file `DEMO-TUDaPub-de.tex' version 4.05-dev (2025-11-12),
%% it is part of
...
\hypersetup{% Zusätzliche/Abweichende Metadaten, falls hier nichts angegeben ist, werden die Daten von \title … verwendet
	...
	pdftitle=TUDaPub – LaTeX-Paper im Corporate Design der TU Darmstadt,
	pdfsubject=Basisdokumentation und Template zur Nutzung der tudapub-Dokumentenkasse,
...
\end{document}
%% End of file `DEMO-TUDaPub-de.tex'.
