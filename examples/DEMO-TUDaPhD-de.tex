%% This is file `DEMO-TUDaPhD-de.tex' version 4.05-dev (2025-11-12),
%% it is part of
...
% Spracheinstellungen
%%%%%%%%%%%%%%%%%%%
\usepackage[english,main=german]{babel}% English wird geladen, um eine Englische Zusammenfassung zu ermöglichen
...
\hypersetup{% Zusätzliche/Abweichende Metadaten, falls hier nichts angegeben ist, werden die Daten von \title … verwendet
	...
	pdftitle=TUDaPhD – LaTeX-Dissertationstemplate im CD der TU Darmstadt (de),
...
% Sofern keine passende Option verfügbar ist es möglich den gesamten Text unter dem Titel zu überschreiben
%\drtext{}

% Die folgenden Felder werden untereinander auf der Titelseite platziert
\department{phys}% Das Kürzel wird automatisch ersetzt und als Studienfach gewählt sofern es definiert ist.
\institute{Institut}
\group{Arbeitsgruppe}
...
In diesem Dokument werden überwiegend die speziell auf Dissertationen ausgelegten Funktionen beschrieben.
...
\end{verbatim}
	\item[department=<Kürzel>] Die Fachbereiche sind fest als Textbausteine in Deutscher sowie Englischer Sprache hinterlegt. Diese Option ermöglicht die Auswahl als Dokumentenklassenoption. Aus Kompatibilitätsgründen kann jedoch auch das Makro \code{department}-Makro hierfür genutzt werden. Zur Verfügung stehen:\par
	      ...
	      Neben den Fachbereichen existieren für Abschlussarbeiten, die keine Dissertationen sind, auch Studienbereiche, siehe auch \file{DEMO-TUDaThesis-de.tex}.
