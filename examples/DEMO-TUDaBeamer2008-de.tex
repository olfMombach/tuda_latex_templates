%% This is file `DEMO-TUDaBeamer2008-de.tex' version 4.05-dev (2025-11-12)
%% it is part of
...
\providecommand{\pdfsave}{\pdfextension save\relax}% workaround} for a bug in trimclip.sty
\providecommand{\pdfrestore}{\pdfextension restore\relax}% workaround} for a bug in trimclip.sty
