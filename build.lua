...
uploadconfig = {
	...
	description = "The TUDa-CI-Bundle provides a possibility to use the Corporate Design of TU Darmstadt in LaTeX. It contains documentclasses as well as some auxiliary packages and config files together with templates for all supported document types.",
	pkg = ctanpkg,
